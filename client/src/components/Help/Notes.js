...
const Notes = () => {
  return (
    <>
      <Title level={3} id="help-notes">Примечания</Title>
      <ol className="help-text">
        <li>
          Для всех систем ГИД Неман в рамках одного браузера на одном компьютере на сервере создается одна сессия.
          Это означает, что работа одновременно под разными аккаунтами в рамках одного браузера невозможна.
        </li>  
        <li>
