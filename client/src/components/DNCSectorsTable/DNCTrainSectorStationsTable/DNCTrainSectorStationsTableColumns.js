...
const dncTrainSectorStationsTableColumns = (props) => {
  const {
    isEditing,
    editingKey,
    handleEdit,
  ...
  return [
    ...
    },
    {
      ...
      width: '20%',
      editable: true,
      // Хочу, чтобы станции всегда выводились в порядке возрастания их позиций в рамках поездного участка
      sortOrder: 'ascend',
      sorter: (a, b) => a[STATION_FIELDS.POS_IN_TRAIN_SECTOR] - b[STATION_FIELDS.POS_IN_TRAIN_SECTOR],
    },
    {
...
export default dncTrainSectorStationsTableColumns;
