...
const getAppDNCSectorObjFromDBDNCSectorObj = (dbDNCSectorObj) => {
  if (dbDNCSectorObj) {
    return {
      ...
      [DNCSECTOR_FIELDS.NOTE]: dbDNCSectorObj.DNCS_DESCRIPTION,
      [DNCSECTOR_FIELDS.PENSI_ID]: dbDNCSectorObj.DNCS_PENSI_ID,
      [DNCSECTOR_FIELDS.PENSI_Code]: dbDNCSectorObj.DNCS_PENSI_Code,
