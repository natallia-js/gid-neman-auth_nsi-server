...
const orderChainSchema = new Schema({
  ...
  // дата и время начала действия первого распоряжения в цепочке (если первое распоряжение в
  // цепочке не имеет даты начала, то дата и время издания распоряжения)
