...
const schema = new Schema({
  ...
  // дата-время последнего редактирования части информации о пользователе
  // (только для отслеживания изменений в полях name, surname, fatherName, post, а также изменений в рабочих
  // полигонах пользователя - т.е. данных, содержащихся в местах, отличных от данной коллекции);
  // для новой записи о пользователе она равна дате-времени добавления записи в коллекцию
  lastEditDateTime: { type: Date, required: true, default: new Date() },
});
