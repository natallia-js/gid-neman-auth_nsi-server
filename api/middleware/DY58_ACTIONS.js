// Список действий, которые пользователь может выполнить с помощью сервера в системе ДУ-58
module.exports = {
  ...
  SET_ORDER_INVALID_MARK: 'SET_ORDER_INVALID_MARK',
  FORCE_CLOSE_OR_OPEN_ORDERS_CHAIN: 'FORCE_CLOSE_OR_OPEN_ORDERS_CHAIN',
  // Все распоряжения
  ADD_ORDER: 'ADD_ORDER',
  MOD_ORDER: 'MOD_ORDER',
